"==============================================================================================================================================
" Enable watching for changes outside vim
"==============================================================================================================================================
...
"colorscheme solarized   " Use Solarized color scheme (http://ethanschoonover.com/solarized)
colorscheme torte
"set autowrite			" Automatically save before commands like :next and :make
"set textwidth=98		" My terminal is 98 characters wide
set textwidth=0         " disable line wrap
set nowrap				" set no line wrap
set nu                  " display line numbers
syntax on
let g:xml_syntax_folding=1 " enable folding in XML
au BufNewFile,BufRead *.lds set filetype=ld     " set file extension .lds to LD syntax highlighting
...
set ruler               " diaplay position of cursor
set foldcolumn=1        " display folding status
set autochdir           " auto change working dir to current doc
set nostartofline       " to ensure go the last line will stay at the same column

filetype plugin on      " turn on plugin
au FileType xml setlocal foldmethod=syntax
au Filetype tpv setlocal foldmethod=syntax

" display gvim in maximized window
